    ...
    public Message reply(Message request) {
        ...
        switch (request.getSubject()){
            ...
            case ADD_AR:
                ...
                requeteBody = (ArrayList<String>) request.getBody();
                try {
                    boolean res = Server.DATABASE.addActionReal(requeteBody.get(0), requeteBody.get(1), Server.DATABASE.recupererIdAction(requeteBody.get(2)));
                    reponse.setBody(res);
                    return reponse;
                }
                catch  (Exception e){
            ...
            case UPDATE_AR:
                requeteBody = (ArrayList<String>) request.getBody();
                reponse.setSubject(Message.Subject.UPDATE_AR);
                reponse.setBody(Server.DATABASE.updateAR(requeteBody.get(0), requeteBody.get(1), requeteBody.get(2), requeteBody.get(3), requeteBody.get(4)));
                return reponse;
